...
impl TokenFactory {
    ...
    // Method to get cost required to create a token
    ...
    // Método para depositar fondos para la cración de un token
    #[payable]
    ...
    // Method to deposit funds for the creation of a token
    ...
    // Method to obtain a token by its id (symbol)
