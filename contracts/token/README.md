...
>Done deploying to dev-1634618395469-76842193388241

In this instance, the account is `dev-1634618395469-76842193388241`. A file has been created containing a key pair to
...
Let's set up an account to transfer some tokens to. These account will be a sub-account of the NEAR account you logged in with.
    ...
    lion.yairnava.testnet
    missatoken.yairnava.testnet
